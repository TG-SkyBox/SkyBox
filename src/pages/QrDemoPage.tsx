...
const QrDemoPage = () => {
  ...
  const [paddingScale, setPaddingScale] = useState(0.2);
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-card p-6 rounded-lg shadow-md">
            ...
            <div className="space-y-4">
              ...
              <div>
                <label className="block text-sm font-medium mb-1">
                  Padding Scale: {(paddingScale * 100).toFixed(0)}%
                </label>
                <input
                  type="range"
                  min="0.05"
        ...
        <div className="mt-8 bg-card p-6 rounded-lg shadow-md">
          ...
          <ul className="list-disc pl-5 space-y-2">
            <li>
              Error Correction Level H ensures the QR code remains scannable
              even with the central logo
            </li>
            <li>
              A white "knockout" area is drawn beneath the logo to prevent
              interference with QR data
            </li>
            <li>
              Logo size is kept within 15-20% of QR width to maintain scanning
              reliability
            </li>
            <li>
              Minimum size of 256px ensures high resolution for reliable
              scanning
            </li>
            <li>
              Canvas-based rendering preserves quality and allows precise
              control
            </li>
          </ul>
        </div>
