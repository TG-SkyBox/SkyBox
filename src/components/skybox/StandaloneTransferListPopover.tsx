...
const transferItemClassName =
  "rounded-xl bg-secondary/25 px-3 py-2 backdrop-blur-md backdrop-saturate-150";

export const StandaloneTransferListPopover = forwardRef<
  HTMLDivElement,
  StandaloneTransferListPopoverProps
