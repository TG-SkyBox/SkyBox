...
function FileGridItem({
  ...
  return (
    <div
      ...
      onDrop={onDrop}
      className={`group flex flex-col items-center p-2 rounded-xl cursor-pointer transition-all duration-200 border ${
        isSelected
    ...
    >
      ...
      <div className="w-full text-center">
        <p
          className="text-body font-medium text-foreground truncate w-full px-1"
          title={file.name}
        >
          {file.name}
        </p>
